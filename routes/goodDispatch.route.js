...
import {
  OrderCancelWarehouse,
  ProductInWarehouse,
  ViewOtp,
  ViewWarehouseByOrder,
  ViewWarehouseOrderCancel,
  ViewWarehouseOrderCompletedOrCancel,
  deleteGoodDispatch,
  saveGoodDispatch,
  sendOtp,
  updateGoodDispatch,
  ...
  viewGoodDispatch,
  viewGoodDispatchById,
  viewOrderForDeliveryBoy,
} from "../controller/goodDispatch.controller.js";
...
router.get(
  "/view-warehouse-order-history/:id",
  ViewWarehouseOrderCompletedOrCancel
);
