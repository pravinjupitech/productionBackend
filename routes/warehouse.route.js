...
import {
  ...
  ViewWarehouse,
  ViewWarehouseById,
  ViewWarehouseByIdRowProduct,
  ViewWarehouseForProduct,
  ViewWarehouseList,
  ViewWarehouseListIncharge,
...
router.get("/view-warehouse-by-id-rowproduct/:id", ViewWarehouseByIdRowProduct);
...
router.get(
  "/view-warehouse-list-incharge/:id/:database",
  ViewWarehouseListIncharge
);
